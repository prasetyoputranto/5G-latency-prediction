...
validation = df_val[(df_val[:,1]==-74)]#1) & (df_val[:,2]==0)]
...
plt.legend()
plt.xlim([7,22])
plt.title('dvp comparison for RSRP=-74dBm')
plt.xlabel('target delay/ms')
plt.ylabel('dvp')
plt.savefig("Rdvp comparison.png") 
...
plt.legend()
plt.xlim([7,22])
plt.title('log dvp comparison for RSRP=-74dBm')
plt.xlabel('target delay/ms')
plt.ylabel('dvp')
plt.savefig("Rlog dvp comparison.png")
...
plt.title('Log dvp error for RSRP=-74dBm')
plt.ylim([0,4])
plt.xlim([7,22])
plt.savefig("Rlog dvp error.png") 
